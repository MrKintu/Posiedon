...
const HomePage: React.FC = () => {
	const { activeMenu, themeColor } = useStateContext(); // Updated to use the correct context
	const [isClient, setIsClient] = React.useState(false);

	React.useEffect(() => {
			setIsClient(true); // Ensures this runs after client hydration
	}, []);

	if (!isClient) return null; // Avoid rendering if it's not on the client
