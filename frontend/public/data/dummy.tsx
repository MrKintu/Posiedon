...
import { AxisModel, ValueType } from '@syncfusion/ej2-charts';
...
// Define prop types for gridOrderImage
...
// Define prop types for gridOrderStatus
...
// Define prop types for gridEmployeeProfile
interface GridEmployeeProfileProps {
    EmployeeImage: string;
    Name: string;
}

const gridEmployeeProfile: React.FC<GridEmployeeProfileProps> = (props) => (
...
// Define prop types for gridEmployeeCountry
interface GridEmployeeCountryProps {
    Country: string;
}

const gridEmployeeCountry: React.FC<GridEmployeeCountryProps> = (props) => (
...
// Define prop types for customerGridImage
...
const customerGridImage: React.FC<CustomerGridImageProps> = (props) => (
...
// Define prop types for customerGridStatus
interface CustomerGridStatusProps {
    StatusBg: string;
    Status: string;
}

const customerGridStatus: React.FC<CustomerGridStatusProps> = (props) => (
...
export const LinePrimaryXAxis: AxisModel = {
	valueType: 'DateTime' as ValueType, // Cast to ValueType
	labelFormat: 'y',
	intervalType: 'Years',
	edgeLabelPlacement: 'Shift',
	majorGridLines: { width: 0 },
...
import { ReactNode } from 'react'; // Make sure to import ReactNode if you're using React components as icons
...
export const earningData: EarningData[] = [
    ...
    {
        icon: <FiBarChart />,
        amount: "423,39", // Consider correcting this value if needed
        percentage: "+38%",
        title: "Sales",
